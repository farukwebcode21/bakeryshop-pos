!(function (e) {
    ...
    function O(t, a, i) {
        ...
        (l._bAttrSrc =
            ...
            t.oFeatures.bSort ||
                ((l.bSortable = !1), s.addClass(o.sSortableNone));
                ...
                for (e.isArray(p) || (p = [p]), s = 0, u = p.length; u > s; s++)
                    if ("number" == typeof p[s] && p[s] >= 0) {
                        ...
                        for (f = 0, c = h.length; c > f; f++)
                            ("_all" == p[s] || e(h[f].nTh).hasClass(p[s])) &&
                                i(f, d);
            }
            ...
            g = function (t) {
                if (n === r || n === c)
                    if (
                        ...
                        p
                            ? (u._setter || (u._setter = te(u.mData)),
                              u._setter(i, d))
                            : (i[c] = d);
                c++;
            };
    ...
    function fe(t, a, n) {
        ...
        if (a) {
            for (n === r && (n = !1), i = 0, l = a.length; l > i; i++) {
                for (
                    h[i] = a[i].slice(), h[i].nTr = a[i].nTr, o = v - 1;
                    o >= 0;
                    o--
                )
    ...
    function ce(t) {
        ...
        if (0 !== v.length)
            for (
                var m = p ? 0 : g, S = p ? t.aoData.length : b, D = m;
                S > D;
                D++
            ) {
                var y = v[D],
                ...
                if (0 !== f) {
                    var T = u[s % f];
                    _._sRowStripe != T &&
                        (e(w).removeClass(_._sRowStripe).addClass(T),
                        (_._sRowStripe = T));
                }
    ...
    function he(t) {
        ...
        for (
            var u, f, c, d, h, p, s = t.sDom.split(""), v = 0;
            v < s.length;
            v++
        ) {
            if (((u = null), (f = s[v]), "<" == f)) {
                if (
                    ((c = e("<div/>")[0]), (d = s[v + 1]), "'" == d || '"' == d)
                ) {
    ...
    function ge(t, a, r) {
        ...
        if (e.isPlainObject(o) && o.data) {
            ...
            (a = "function" == typeof l && f ? f : e.extend(!0, a, f)),
                delete o.data;
        }
        var c = {
            data: a,
                ...
                for (s = [], i = 0, o = t.length; o > i; i++)
                    (a = t[i]),
                        ...
                        u.indexOf &&
                            -1 !== u.indexOf("&") &&
                            ((Ae.innerHTML = u),
                            (u = Fe ? Ae.textContent : Ae.innerText)),
    ...
    function We(t) {
        ...
        return (
            ...
            c
                .children()
                .append(
                    t.oLanguage.sLengthMenu.replace("_MENU_", s[0].outerHTML)
                ),
            e("select", c)
            ...
            D.outerWidth() < U
                ? ((E =
                  ...
                  x &&
                      ...
                      (w.width = Ke(E - o)),
                  ("" === n || "" !== i) &&
                      ft(t, 1, "Possible column misalignment", 6))
                : (E = "100%"),
            (v.width = Ke(E)),
            (u.width = Ke(E)),
    ...
    function $e(a) {
        ...
        for (_ && -1 !== _.indexOf("%") && (d = _), v = 0; v < f.length; v++)
            (g = n[f[v]]),
                null !== g.sWidth &&
                    ((g.sWidth = Ye(g.sWidthOrig, h)), (p = !0));
    ...
    function et(t) {
        ...
        for (
            ...
            for (
                p = b[a][0], c = f[p].aDataSort, l = 0, o = c.length;
                o > l;
                l++
            )
                (d = c[l]),
                    (h = f[d].sType || "string"),
                    b[a]._idx === r &&
                        (b[a]._idx = e.inArray(b[a][1], f[d].asSorting)),
                    s.push({
                        src: p,
                        col: d,
                        dir: b[a][1],
            ...
            c.removeAttribute("aria-sort"),
                s.bSortable
                    ? (n.length > 0 && n[0].col == l
                      ...
                      (t =
                          f +
                          ("asc" === a ? i.sSortAscending : i.sSortDescending)))
                    : (t = f),
    ...
    function it(t) {
        ...
        if (i.bSort && i.bSortClasses) {
            for (l = 0, o = a.length; o > l; l++)
                (s = a[l].src),
                    e(y(t.aoData, "anCells", s)).removeClass(
                        r + (2 > l ? l + 1 : 3)
                    );
            for (l = 0, o = n.length; o > l; l++)
                (s = n[l].src),
                    e(y(t.aoData, "anCells", s)).addClass(
                        r + (2 > l ? l + 1 : 3)
                    );
        }
        t.aLastSort = n;
        ...
        var i,
            ...
            s = function (a) {
                ...
                if (
                    ...
                    a.start !== r &&
                        ((t._iDisplayStart = a.start),
                        (t.iInitDisplayStart = a.start)),
                    ...
                    for (i = 0, l = a.columns.length; l > i; i++) {
                        ...
                        f.visible !== r && (o[i].bVisible = f.visible),
                            f.search !== r &&
                                e.extend(t.aoPreSearchCols[i], Re(f.search));
                    }
        ...
        e.each(
            ...
            function (e, a) {
                (i.type.order[e + t + "-pre"] = a),
                    e.match(/^html\-/) &&
                        (i.type.search[e + t] = i.type.search.html);
            }
        );
    }
    function qt(e) {
        ...
        n = function (t) {
            (this.$ = function (e, t) {
                ...
                (this.fnAddData = function (t, a) {
                    var n = this.api(!0),
                        i =
                            e.isArray(t) &&
                            (e.isArray(t[0]) || e.isPlainObject(t[0]))
                                ? n.rows.add(t)
                                : n.row.add(t);
            ...
            return (
                this.each(function () {
                    ...
                    (null === v || "" === v) &&
                        ((v = "DataTables_Table_" + n.ext._unique++),
                        (this.id = v));
            ...
            var i = [],
                l = function (a, r) {
                    if (e.isArray(a) || a instanceof e)
                        ...
                        (e("td", s).addClass(r).html(a)[0].colSpan = E(t)),
                            i.push(s[0]);
                    }
                };
            l(r, n),
            ...
            return (
                ...
                this.iterator("table", function (r) {
                    ...
                    (r.bDestroying = !0),
                        ...
                        s != f.parentNode &&
                            (d.children("thead").detach(), d.append(f)),
                        c &&
                            s != c.parentNode &&
    ...
    var Vt = function (e, t, a, r) {
        return 0 === e || (e && "-" !== e)
            ? (t && (e = b(e, t)),
              e.replace &&
                  (a && (e = e.replace(a, "")), r && (e = e.replace(r, ""))),
              1 * e)
            : -(1 / 0);
    };
            ...
            header: {
                ...
                jqueryui: function (t, a, r, n) {
                    e("<div/>")
                        ...
                        .append(
                            e("<span/>").addClass(
                                n.sSortIcon + " " + r.sSortingClassJUI
                            )
                        )
                        .appendTo(a),
                        e(t.nTable).on("order.dt.DT", function (e, i, l, o) {
